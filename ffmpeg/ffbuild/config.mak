...
CP=cp -p
LN_S=ln -s -f
CPPFLAGS= --sysroot=/Volumes/Data/Git/android-ndk-r14b/platforms/android-21/arch-arm64/ -isysroot /Volumes/Data/Git/android-ndk-r14b/platforms/android-21/arch-arm64/ -D_ISOC99_SOURCE -D_FILE_OFFSET_BITS=64 -D_LARGEFILE_SOURCE -Dstrtod=avpriv_strtod -DPIC -DZLIB_CONST
CFLAGS=  -I/Users/guaishou/Git/Github/ffmpeg-android-build/build/x264/android/arm64/include -std=c11 -fomit-frame-pointer -fPIC -pthread -g -Wdeclaration-after-statement -Wall -Wdisabled-optimization -Wpointer-arith -Wredundant-decls -Wwrite-strings -Wtype-limits -Wundef -Wmissing-prototypes -Wno-pointer-to-int-cast -Wstrict-prototypes -Wempty-body -Wno-parentheses -Wno-switch -Wno-format-zero-length -Wno-pointer-sign -Os -fno-math-errno -fno-signed-zeros -fno-tree-vectorize -Werror=format-security -Werror=implicit-function-declaration -Werror=missing-prototypes -Werror=return-type -Werror=vla -Wformat -fdiagnostics-color=auto -Wno-maybe-uninitialized
CXXFLAGS=  -D__STDC_CONSTANT_MACROS -std=c++11
OBJCFLAGS=  
ASFLAGS=  -I/Users/guaishou/Git/Github/ffmpeg-android-build/build/x264/android/arm64/include -fPIC -g
...
EXTRALIBS=-lx264 -lm  -lz -pthread -pthread -lgcc 
